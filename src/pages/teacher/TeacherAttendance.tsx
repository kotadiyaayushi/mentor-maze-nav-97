...
const TeacherAttendance = () => {
  ...
  const [attendanceMode, setAttendanceMode] = useState<'view' | 'mark'>('view');
  ...
  const getStudentAttendanceForDate = (studentId: string, date: string, courseId: string) => {
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                {students.map(student => {
                  ...
                  return (
                    <div key={student.id} className="flex items-center justify-between p-3 bg-surface rounded-lg">
                      <div className="flex items-center gap-3">
                        <div>
